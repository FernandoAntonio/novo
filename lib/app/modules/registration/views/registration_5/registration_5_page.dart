...
class Registration5Page extends StatefulWidget {
  final String title;
  const Registration5Page({Key key, this.title = "Registration5"}) : super(key: key);
...
class _Registration5PageState
    extends ModularState<Registration5Page, Registration5Controller> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          RaisedButton(
            onPressed: () => Modular.navigator.pushNamed('/Registration6Page'),
